...
export const services = [
  {
    id: 1,
    icon: "/assets/images/adobe/illustrator.png",
    title: "Adobe Illustrator",
    projects: "Vektorová grafika",
    animationOrder: "1",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    icon: "/assets/images/adobe/indesign.png",
    title: "InDesign",
    projects: "Tiskové materiály",
    animationOrder: "3",
  },
  {
    id: 4,
    icon: "/assets/images/adobe/photoshop.png",
    title: "Photoshop",
    projects: "Foto retušování",
    animationOrder: "4",
  },
].map((elm) => {
  return {
...
export const serviceCards2 = [
  {
    number: "01.",
    title: "Reklamní tiskoviny",
    description:
      "Návrhy letáků, plakátů a dalších marketingových materiálů. Od konceptu přes realizaci až po finální tisk a doručení.",
  },
  {
    number: "02.",
    title: "Firemní identita & Brand manuály",
    description:
      "Komplexní tvorba vizuální identity značky včetně loga, barevné palety, typografie a kompletního brand manuálu.",
  },
  {
    number: "03.",
    title: "Velkoformátové tisky",
    description:
      "Profesionální příprava a realizace velkoplošných reklam, bannerů, billboardů a dalších velkoformátových tisků.",
  },
];
